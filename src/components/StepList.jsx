    ...
    <Section>
      <Container customStyles="space-y-12">
        ...
        <ul className="space-y-12">
          ...
          <StepListItem
            title={t("home.steps.step5.title")}
            body={t("home.steps.step5.text")}
            icon={
              <Fragment>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
